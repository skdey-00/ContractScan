  ...
  return (
    ...
    >
      <div className="p-4">
        ...
        <p className="mt-2 text-sm text-gray-500 italic">{recommendation}</p>

        {suggestedRewrite && isFlagged && (
          <div className="mt-3">
            <button
              onClick={() => setRewriteExpanded(!rewriteExpanded)}
              className="text-xs font-semibold text-blue-600 hover:text-blue-800 focus:outline-none inline-flex items-center gap-1"
            >
            ...
            {rewriteExpanded && (
              <div className="mt-2 p-3 bg-blue-50 border border-blue-100 rounded text-sm text-gray-700 leading-relaxed whitespace-pre-line">
                {suggestedRewrite}
              </div>
            )}
          </div>
        ...
        {details && expanded && (
          <div className="mt-2 p-3 bg-gray-50 rounded text-sm text-gray-600 leading-relaxed">
            {details}
          </div>
        )}
      </div>
